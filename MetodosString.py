...
s = "hola mundo"
print(f'{s.find("mundo") = }')  # Output: 5 (s.find("mundo"))  # Output: 5

# rfind(): Encuentra la último ocurrencia de una subcadena en una cadena.
s = "hola mundo"
print(f'{s.rfind("mundo") = }')  # Output: 5 (s.rfind("mundo"))  # Output: 5

# index(): Encuentra la primera ocurrencia de una subcadena en una cadena.
s = "hola mundo"
print(f'{s.index("mundo") = }')  # Output: 5 (s.index("mundo"))  # Output: 5

# rindex(): Encuentra la último ocurrencia de una subcadena en una cadena.
s = "hola mundo"
print(f'{s.rindex("mundo") = }')  # Output: 5 (s.rindex("mundo"))  # Output: 5

# replace(): Reemplaza todas las ocurrencias de una subcadena en una cadena.
s = "hola mundo"
print(f'{s.replace("mundo", "python") = }')  # Output: "hola python" (s.replace("mundo", "python"))  # Output: "hola python"